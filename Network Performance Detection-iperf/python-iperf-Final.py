...
for filename in os.listdir (folder):
    ...
    for i, line in enumerate(fp):
        if (i == 6):
            ...
            if (float(speednumber[6])) < 500 and (float(speednumber[6])) > 400:
               msg_low_sh += "<tr color=\"#ff6600\" bgcolor='ff6600' height = '20'><td>" + filename.split('.')[0] + "</td><td> Busy Speed: " + speednumber[6] + "Mbits. We should monitor this machine.</td></tr>\n"
               continue
            if (float(speednumber[6])) <400:
               msg_low_us +=  "<tr color=\"#ff0000\" bgcolor='ff0000'  height = '20'><td>" + filename.split('.')[0] + "</td><td>Low Speed: " + speednumber[6] + "Mbits. We should notice this machine.</td></tr>\n"
               continue
            else:
              msg_normal +=  "<tr color=\"#036803\" bgcolor='036803' height = '20'><td>" + filename.split('.')[0] + "</td><td> Normal Speed: " + speednumber[6] + "Mbits.</td></tr>\n"
    fp.close()
#print (msg_low_sh)
#print (msg_low_us)
#print (msg_normal)
...
strFrom = "iperf@company.com.tw"
#strTo = ["a","b","c"]
strTo = ["abc@company.com.tw"]
